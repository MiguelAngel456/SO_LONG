...
/*   Updated: 2024/02/13 17:18:34 by mfuente-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_texture(t_list_map *info_map)
{
	...
	info_map->imgTree = mlx_load_png("./assets/environment/Tree.png");
 	...
 	info_map->imgOrcM = mlx_load_png("./assets/orc-png/orc-run.png");
	info_map->imgSlime = mlx_load_png("./assets/slime-png/slime-idle.png");
	info_map->imgSlimeM = mlx_load_png("./assets/slime-png/slime-jump.png");
	info_map->imgPrinc = mlx_load_png("./assets/female/princes2.png");
	info_map->imgPrincM = mlx_load_png("./assets/female/princes1.png");
...
void	free_textures(t_list_map *info_map)
{
	...
	mlx_delete_texture(info_map->imgOrcM);
	mlx_delete_texture(info_map->imgSlime);
	mlx_delete_texture(info_map->imgSlimeM);
	mlx_delete_texture(info_map->imgPrinc);
	mlx_delete_texture(info_map->imgPrincM);
